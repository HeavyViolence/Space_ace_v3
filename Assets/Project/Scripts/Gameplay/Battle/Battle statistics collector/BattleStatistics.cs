...
{
    public readonly struct BattleStatistics : IComparable<BattleStatistics>, IComparer<BattleStatistics>
    {
        public static BattleStatistics Default => new(0, 0, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 0f, 0f, 0f, 0f,
                                                      0f, 0, 0, 0, 0, DateTime.MinValue, TimeSpan.Zero);
        ...
        public int EliteEnemiesDefeated { get; }
        ...
        public BattleStatistics(int shotsFired,
                                int hits,
                                float damageDealt,
                                float damageLost,
                                ...
                                TimeSpan runTime)
        {
            ...
            EliteEnemiesDefeated = Mathf.Clamp(eliteEnemiesDefeated, 0, int.MaxValue);
        ...
        public BattleStatistics(BattleStatisticsCache cache, DateTime date, TimeSpan runTime)
        {
            ...
            EliteEnemiesDefeated = Mathf.Clamp(cache.EliteEnemiesDefeated, 0, int.MaxValue);
            BossesDefeated = Mathf.Clamp(cache.BossesDefeated, 0, int.MaxValue);
        ...
        public int CompareTo(BattleStatistics other)
        {
        ...
        public int Compare(BattleStatistics x, BattleStatistics y)
        {
        ...
        public static bool operator >(BattleStatistics x, BattleStatistics y) =>
